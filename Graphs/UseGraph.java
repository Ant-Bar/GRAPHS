public class UseGraph{
    ...
    // other reachable vertex in graph.
    {
        ...
        PriorityQueueInterface<Flight> pq = new HeapPriorityQueue<Flight>(20);   // Assume at most 20 vertices
        String vertex;
        QueueInterface<String> vertexQueue = new LinkedListQueue<String>();
...
{
    QueueInterface<String> queue = new LinkedListQueue<String>();
    QueueInterface<String> vertexQueue = new LinkedListQueue<String>();
    ...
    public static void main(String[] args){
        ...
        graph.addEdge(s0, s5, 800);//atlanta to houston
        graph.addEdge(s0, s6, 600);//atlanta to washington
        graph.addEdge(s1, s3, 200);//austin  to dallas
        graph.addEdge(s1, s5, 160);//austin  to houston
        graph.addEdge(s2, s4, 1000);//chicago to denver
        graph.addEdge(s3, s1, 200);//dallas to austin
        graph.addEdge(s3, s2, 900);//dallas to chicago
        graph.addEdge(s3, s4, 780);//dallas to denver
        graph.addEdge(s4, s0, 1400);//denver to atlanta
        graph.addEdge(s4, s2, 1000);//denver to chicago
        graph.addEdge(s5, s0, 800);//houston to atlanta
        graph.addEdge(s6, s0, 600);//washington to atlanta
        graph.addEdge(s6, s3, 1300);//washington to dallas
